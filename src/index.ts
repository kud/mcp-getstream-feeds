...
server.registerTool(
  ...
  {
    description:
      "Get what feeds a specific feed follows (i.e. what a user is subscribed to). Example: feed_slug=user_mobile_push, feed_id=InsightsProfile_366401",
    inputSchema: {
      feed_slug: z.string().describe('Feed slug (e.g. "user_mobile_push")'),
      feed_id: z.string().describe('Feed ID (e.g. "InsightsProfile_366401")'),
      limit: z
        .number()
        .default(100)
...
server.registerTool(
  ...
  {
    description:
      "Get followers of a specific feed (i.e. who is subscribed to a feed). Example: feed_slug=streams_updated, feed_id=streams_updated_all",
    inputSchema: {
      feed_slug: z.string().describe('Feed slug (e.g. "streams_updated")'),
      feed_id: z.string().describe('Feed ID (e.g. "streams_updated_all")'),
      limit: z
        .number()
        .default(100)
        .describe("Max number of results to return"),
